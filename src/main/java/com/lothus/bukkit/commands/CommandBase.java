package com.lothus.bukkit.commands;
...
public abstract class CommandBase extends Command {
    ...
    public String NO_PERMISSION = "§cVocê não tem permissão para executar este comando";
    ...
    public CommandBase(String name, String description, List<String> aliases) {
